...
2. [Condomínio Task Manager](https://github.com/igormath/seu_condominio-test)
   - This was my first time using Angular on Front-end and 'Zod' library for validation on Back-end it was an good experience.

3. [Chimpobot](https://github.com/igormath/chimpobot)
